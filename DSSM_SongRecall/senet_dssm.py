...
from dssm_preprocess import gen_data_set, gen_model_input, gen_test_inpout, gen_data_set_new
import numpy as np
...
if __name__ == "__main__":
    ...
    train_set, test_set, history_items, hot_ids = gen_data_set_new(data, min_count, negsample)  # 获取训练集和测试集，训练集和测试集采样方法可修改
    ...
    for i, uid in tqdm(enumerate(test_user_model_input['user_id'])):
        try:
            ...
            # print(rec_10, rec_50, test_true_label[uid])
    ...
    print("hr", hit / max(1, (len(test_user_model_input['user_id']) - hot_count)))
